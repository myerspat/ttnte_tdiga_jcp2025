...
if __name__ == "__main__":
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig("./meshsize/figs/leakage.eps", dpi=700, transparent=False)
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig("./meshsize/figs/leakage_relerror.eps", dpi=700, transparent=False)
    ...
    plt.legend(ncol=2, fontsize=10)
    plt.tight_layout()
    plt.savefig("./meshsize/figs/flux_l2error.jpeg", dpi=700, transparent=False)
